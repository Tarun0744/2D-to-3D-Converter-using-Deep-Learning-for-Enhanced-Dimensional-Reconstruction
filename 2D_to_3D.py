...
class MultiViewDataset(Dataset):
    def __init__(self, root_dir, transform=None, img_size=224, num_points=2048, voxel_size=64):
        ...
        self.transform = transform or transforms.Compose([
            ...
            transforms.RandomCrop(img_size, padding=10),  # Added cropping
            transforms.ToTensor(),
    ...
    def _create_enhanced_sample_data(self):
        ...
        # Create background directory (placeholder; replace with actual backgrounds)
...
def post_process_voxels(voxels, sigma=0.5):
    ...
    binary = binary_dilation(binary, structure=np.ones((3,3,3))).astype(np.float32)  # Added dilation
    return binary
